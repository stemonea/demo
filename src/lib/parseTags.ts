...
export type TagNode =
  ...
  /** `raw` is the opener as it was written, e.g. `<Crosstalk>`, for markup that turns out not to be a tag */
  | { type: 'tag'; name: string; raw: string; kind: TagKind | 'unknown'; unclosed: boolean; children: TagNode[] }
